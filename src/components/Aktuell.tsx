...
export default function Aktuell() {
  return (
    <div
      id="aktuell"
      className="flex justify-center items-center pt-16 ld:pt-20 pb-10 md:pb-20"
    >
        ...
        <div className="pt-12 pb-12 md:px-10 bg-darkbg leading-8">
          ...
          >
            ...
            <p className="mb-3 text-lg lg:text-xl pt-2">
              Aktuell gibt es noch keinen Workshop.
            </p>
            ...
            <p className="mb-3 text-lg lg:text-xl pt-2">
              Wenn du möchtest, dass ich einen Workshop für dein Unternehmen,
              deine Feier oder deine Gruppe gestalte: Kontaktiere mich gerne
              direkt per{" "}
              <a
                className="text-red hover:text-contrast cursor-pointer"
                href="#kontakt"
              >
                Mail oder Telefon.
              </a>
